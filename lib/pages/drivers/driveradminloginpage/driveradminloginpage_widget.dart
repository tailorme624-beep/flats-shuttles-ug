...
import 'driveradminloginpage_model.dart';
export 'driveradminloginpage_model.dart';

/// design a driver login page fof loggingin with Admin Login credentials.
///
/// with theme colors, army green and light beige
class DriveradminloginpageWidget extends StatefulWidget {
  const DriveradminloginpageWidget({super.key});

  static String routeName = 'driveradminloginpage';
  static String routePath = '/driveradminloginpage';

  @override
  State<DriveradminloginpageWidget> createState() =>
      _DriveradminloginpageWidgetState();
}

class _DriveradminloginpageWidgetState
    extends State<DriveradminloginpageWidget> {
  late DriveradminloginpageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DriveradminloginpageModel());
