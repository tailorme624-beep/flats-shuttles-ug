...
import 'activeride_model.dart';
export 'activeride_model.dart';
                  ...
                  child: Container(
                    ...
                    child: Padding(
                      ...
                      child: InkWell(
                        ...
                        onTap: () async {
                          logFirebaseEvent(
                              'ACTIVERIDE_PAGE_Column_ui6d4tdh_ON_TAP');
                          currentUserLocationValue =
                              await getCurrentUserLocation(
                                  defaultLocation: LatLng(0.0, 0.0));
                          logFirebaseEvent('Column_launch_map');
                          await launchMap(
                                  ...
                                  Padding(
                                    ...
                                    child: StreamBuilder<List<RidesRecord>>(
                                      ...
                                      builder: (context, snapshot) {
                                        ...
                                        List<RidesRecord>
                                            containerRidesRecordList =
                                            snapshot.data!;
                                        // Return an empty Container when the item does not exist.
                                        if (snapshot.data!.isEmpty) {
                                          return Container();
                                        }
                                        final containerRidesRecord =
                                            containerRidesRecordList.isNotEmpty
                                                ? containerRidesRecordList.first
                                                : null;
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      FFButtonWidget(
                                        onPressed: () async {
                                          logFirebaseEvent(
                                              'ACTIVERIDE_NAVIGATE_WITH_GOOGLE_MAPS_BTN');
                                          currentUserLocationValue =
                                              await getCurrentUserLocation(
                                                  defaultLocation:
                                                      LatLng(0.0, 0.0));
                                          ...
                                          await launchMap(
                                            mapType: $ml.MapType.google,
                                            location: currentUserLocationValue,
                                            title: currentUserLocationValue!
                                                .toString(),
                                          );
                                        },
                                        text:
                      ...
                      child: Row(
                        ...
                        children: [
                          FlutterFlowIconButton(
                            ...
                            onPressed: () async {
                              logFirebaseEvent(
                                  'ACTIVERIDE_arrow_back_rounded_ICN_ON_TAP');
