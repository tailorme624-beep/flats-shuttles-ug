...
export 'driveractiveridepage_model.dart';
...
class DriveractiveridepageWidget extends StatefulWidget {
  const DriveractiveridepageWidget({super.key});

  static String routeName = 'driveractiveridepage';
  static String routePath = '/driveractiveridepage';

  @override
  State<DriveractiveridepageWidget> createState() =>
      _DriveractiveridepageWidgetState();
}

class _DriveractiveridepageWidgetState
    extends State<DriveractiveridepageWidget> {
  late DriveractiveridepageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DriveractiveridepageModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'driveractiveridepage'});
                      ...
                      child: Row(
                        ...
                        children: [
                          FlutterFlowIconButton(
                            ...
                            onPressed: () async {
                              logFirebaseEvent(
                                  'DRIVERACTIVERIDEarrow_back_rounded_ICN_O');
