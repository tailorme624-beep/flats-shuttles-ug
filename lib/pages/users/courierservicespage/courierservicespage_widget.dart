                        ...
                        child: Column(
                          ...
                          children: [
                              ...
                              child: Container(
                                ...
                                child: TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    hintText:
                                        FFLocalizations.of(context).getText(
                                      'serndlgk' /* Enter delivery address */,
                                    ),
                                    hintStyle: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
                              ...
                              child: Container(
                                ...
                                child: FlutterFlowDropDown<String>(
                                  ...
                                  optionLabels: [
                                    ...
                                    FFLocalizations.of(context).getText(
                                      'bp8d5rnz' /* Express (1-2 business days) */,
                                    ),
                                    FFLocalizations.of(context).getText(
                                      'gpty53ms' /* Same Day (within 24 hours) */,
                                    )
                                  ],
                                  onChanged: (val) => safeSetState(
                                  ...
                                  hintText: FFLocalizations.of(context).getText(
                                    '2xdoj0pv' /* Select delivery speed */,
                                  ),
                                  icon: Icon(
                                    Icons.keyboard_arrow_down_rounded,
                                    color: Color(0xFF556B2F),
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Expanded(
                                        child: Text(
                                          FFLocalizations.of(context).getText(
                                            'nt8ywdun' /* Pricing will be calculated bas... */,
                                          ),
                                          style: FlutterFlowTheme.of(context)
                                              .bodySmall
                                              .override(
                            ...
                            Align(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  'gsi2g2sr' /* © 2025 FLATS UG. All rights re... */,
                                ),
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
