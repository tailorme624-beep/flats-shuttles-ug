...
///
/// Include clear options to switch between Individual and Group booking.
/// Capture essential fields: Tour Name/Theme (Pre-selected), Date & Time
/// (Picker), Number of Participants (Split into Adults/Children), Language
/// Preference (Dropdown), and a Dietary/Accessibility Requirements (Text
                  ...
                  child: Column(
                    ...
                    children: [
                                              ...
                                              children: [
                                                ...
                                                Padding(
                                                  ...
                                                  child: Text(
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                      'uf6mer8p' /* Historic City Walking Tour */,
                                                    ),
                                                    style: FlutterFlowTheme.of(
                                                            context)
                                                        .titleSmall
                                ...
                                Column(
                                  ...
                                  children: [
                                    Padding(
                                      ...
                                      child: Text(
                                        FFLocalizations.of(context).getText(
                                          '9yjfi88p' /* Dietary & Accessibility Requir... */,
                                        ),
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                                    ...
                                    TextFormField(
                                      ...
                                      decoration: InputDecoration(
                                        hintText:
                                            FFLocalizations.of(context).getText(
                                          'bpgdtndg' /* Please specify any dietary res... */,
                                        ),
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: Text(
                                    FFLocalizations.of(context).getText(
                                      'xkovhuzz' /* Group bookings (5+ people) may... */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .bodySmall
                                        .override(
                      ...
                      Align(
                        ...
                        child: Text(
                          FFLocalizations.of(context).getText(
                            'bvezcopt' /* © 2025 FLATS UG. All rights re... */,
                          ),
