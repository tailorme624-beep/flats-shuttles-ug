...
class RideBookingPageWidget extends StatefulWidget {
  const RideBookingPageWidget({super.key});
                                    ...
                                    FlutterFlowDropDown<String>(
                                      controller:
                                        ...
                                        _model.dropDownValue ??=
                                            FFLocalizations.of(context).getText(
                                          'xbm94uj5' /* Select Payment Method */,
                                        ),
                                      ),
                                      options: [
                                        FFLocalizations.of(context).getText(
                                          'rgpdgnvl' /* Mobile Money */,
                                        ),
                                        FFLocalizations.of(context).getText(
                                          'tz62wbng' /* Credit Card */,
                                        ),
                                        FFLocalizations.of(context).getText(
                                          'xmzhcxr8' /* Cash on Delivery */,
                                        ),
                                        FFLocalizations.of(context).getText(
                                          'foyriwwp' /* Bank Transfer */,
                                        ),
                                        FFLocalizations.of(context).getText(
                                          'on58nqvi' /* Select Payment Method */,
                                        )
                                      ],
                                      ...
                                      hintText:
                                          FFLocalizations.of(context).getText(
                                        '4piri071' /* Select payment option */,
                                      ),
                                      icon: Icon(
