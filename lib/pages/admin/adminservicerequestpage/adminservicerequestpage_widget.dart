...
import 'adminservicerequestpage_model.dart';
export 'adminservicerequestpage_model.dart';
...
class AdminservicerequestpageWidget extends StatefulWidget {
  const AdminservicerequestpageWidget({super.key});

  static String routeName = 'adminservicerequestpage';
  static String routePath = '/adminservicerequestpage';

  @override
  State<AdminservicerequestpageWidget> createState() =>
      _AdminservicerequestpageWidgetState();
}

class _AdminservicerequestpageWidgetState
    extends State<AdminservicerequestpageWidget> {
  late AdminservicerequestpageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdminservicerequestpageModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'adminservicerequestpage'});
