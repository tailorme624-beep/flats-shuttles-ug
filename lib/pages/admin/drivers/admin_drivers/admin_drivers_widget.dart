...
class _AdminDriversWidgetState extends State<AdminDriversWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('ADMIN_DRIVERS_AdminDrivers_ON_INIT_STATE');
      logFirebaseEvent('AdminDrivers_firestore_query');
      _model.count = await queryDriversRecordCount();
      if (_model.count! > 0) {
        logFirebaseEvent('AdminDrivers_firestore_query');
        _model.allDrivers = await queryUsersRecordOnce(
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Builder(
                            builder: (context) {
                              final drivers = _model.allDrivers?.toList() ?? [];
                              ...
                              return ListView.builder(
                                ...
                                itemBuilder: (context, driversIndex) {
                                  ...
                                  return wrapWithModel(
                                    model:
                                        _model.adminDriverCardModels.getModel(
                                      driversItem.uid,
                                      driversIndex,
                                    ),
                                    updateCallback: () => safeSetState(() {}),
