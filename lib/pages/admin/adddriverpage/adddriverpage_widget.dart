...
import 'adddriverpage_model.dart';
export 'adddriverpage_model.dart';
...
class AdddriverpageWidget extends StatefulWidget {
  ...
  /// hold image uploaded
  final FFUploadedFile? imageupload;
          ...
          child: Scaffold(
            ...
            appBar: AppBar(
              ...
              leading: FlutterFlowIconButton(
                ...
                onPressed: () async {
                  logFirebaseEvent('ADDDRIVERarrow_back_rounded_ICN_ON_TAP');
            ...
            body: SafeArea(
              ...
              child: Padding(
                ...
                child: InkWell(
                  ...
                  onTap: () async {
                    logFirebaseEvent('ADDDRIVERColumn_dzp37zle_ON_TAP');
                    logFirebaseEvent('Column_backend_call');

                    await AdminDriverRecord.createDoc(currentUserReference!)
                                ...
                                children: [
                                  ...
                                  TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      hintText:
                                          FFLocalizations.of(context).getText(
                                        'gcc418jg' /* Create username for driver */,
                                      ),
                                      hintStyle: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
