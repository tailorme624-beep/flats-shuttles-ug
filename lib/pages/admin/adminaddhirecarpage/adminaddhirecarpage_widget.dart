...
import 'adminaddhirecarpage_model.dart';
export 'adminaddhirecarpage_model.dart';

/// design "ADD tour places" page for the admin to add available tour places
/// and there costs  to be viewed by user when added by the admin.
///
/// with theme colors, light beige and army green
class AdminaddhirecarpageWidget extends StatefulWidget {
  const AdminaddhirecarpageWidget({super.key});

  static String routeName = 'Adminaddhirecarpage';
  static String routePath = '/adminaddhirecarpage';

  @override
  State<AdminaddhirecarpageWidget> createState() =>
      _AdminaddhirecarpageWidgetState();
}

class _AdminaddhirecarpageWidgetState extends State<AdminaddhirecarpageWidget> {
  late AdminaddhirecarpageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdminaddhirecarpageModel());
                    ...
                    children: [
                              ...
                              ClipRRect(
                                ...
                                child: CachedNetworkImage(
                                  ...
                                  imageUrl: getCORSProxyUrl(
                                    'https://images.unsplash.com/photo-1570141563051-d5eac266e8c7?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHJhbmRvbXx8fHx8fHx8fDE3NjI1MDE0ODd8&ixlib=rb-4.1.0&q=80&w=1080',
                                  ),
                                  width: double.infinity,
                        ...
                        children: [
                          ...
                          TextFormField(
                            ...
                            decoration: InputDecoration(
                              ...
                              hintText: FFLocalizations.of(context).getText(
                                'rssrfoav' /* Car Make (e.g., Toyota, Honda) */,
                              ),
                          ...
                          TextFormField(
                            ...
                            decoration: InputDecoration(
                              ...
                              hintText: FFLocalizations.of(context).getText(
                                'acgkd0mv' /* Car Model (e.g., Camry, Civic) */,
                              ),
                              hintStyle: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
                      ...
                      Column(
                        ...
                        children: [
                          Text(
                            FFLocalizations.of(context).getText(
                              'vnhzq1t0' /* Additional Information */,
                            ),
                            style: FlutterFlowTheme.of(context)
                                .titleMedium
                                .override(
                          ...
                          TextFormField(
                            ...
                            decoration: InputDecoration(
                              ...
                              hintText: FFLocalizations.of(context).getText(
                                'a7b5zn3z' /* Enter any additional features,... */,
                              ),
                              hintStyle: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
