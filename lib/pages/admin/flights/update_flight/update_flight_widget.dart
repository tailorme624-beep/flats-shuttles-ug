...
import 'update_flight_model.dart';
export 'update_flight_model.dart';

/// design an admin edit flight page with theme colors army green and light
/// beige.
class UpdateFlightWidget extends StatefulWidget {
  const UpdateFlightWidget({super.key});

  static String routeName = 'UpdateFlight';
  static String routePath = '/updateFlight';

  @override
  State<UpdateFlightWidget> createState() => _UpdateFlightWidgetState();
}

class _UpdateFlightWidgetState extends State<UpdateFlightWidget> {
  late UpdateFlightModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UpdateFlightModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'UpdateFlight'});
