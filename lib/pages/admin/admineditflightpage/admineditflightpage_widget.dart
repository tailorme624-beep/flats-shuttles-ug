...
import 'admineditflightpage_model.dart';
export 'admineditflightpage_model.dart';

/// design an admin edit flight page with theme colors army green and light
/// beige.
class AdmineditflightpageWidget extends StatefulWidget {
  const AdmineditflightpageWidget({super.key});

  static String routeName = 'admineditflightpage';
  static String routePath = '/admineditflightpage';

  @override
  State<AdmineditflightpageWidget> createState() =>
      _AdmineditflightpageWidgetState();
}

class _AdmineditflightpageWidgetState extends State<AdmineditflightpageWidget> {
  late AdmineditflightpageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdmineditflightpageModel());
