...
class _AdminLoginWidgetState extends State<AdminLoginWidget> {
  ...
  void initState() {
    ...
    _model.adminLoginPasswordTextController ??= TextEditingController();
                        ...
                        Form(
                          ...
                          child: Column(
                            ...
                            children: [
                              TextFormField(
                                controller:
                                    _model.adminLoginEmailTextController,
                                focusNode: _model.adminLoginEmailFocusNode,
                                autofocus: false,
                              ...
                              Autocomplete<String>(
                                ...
                                optionsViewBuilder:
                                  ...
                                  return AutocompleteOptionsList(
                                    textFieldKey: _model.adminLoginPasswordKey,
                                    textController: _model
                                        .adminLoginPasswordTextController!,
                                ...
                                onSelected: (String selection) {
                                  safeSetState(() =>
                                      _model.adminLoginPasswordSelectedOption =
                                          selection);
                                  FocusScope.of(context).unfocus();
                                },
                                fieldViewBuilder: (
                                  ...
                                  _model.adminLoginPasswordFocusNode =
                                      focusNode;

                                  _model.adminLoginPasswordTextController =
                                      textEditingController;
                                  return TextFormField(
                                    key: _model.adminLoginPasswordKey,
                                    ...
                                    obscureText:
                                        !_model.adminLoginPasswordVisibility,
                                    decoration: InputDecoration(
                                      labelText:
                                          FFLocalizations.of(context).getText(
                                        '48usjl95' /* Password */,
                              ...
                              FFButtonWidget(
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'ADMIN_LOGIN_PAGE_LoginButton_ON_TAP');
                                  ...
                                  final user =
                                    ...
                                    context,
                                    _model.adminLoginEmailTextController.text,
                                    _model
                                        .adminLoginPasswordTextController.text,
                                  );
                                  if (user == null) {
                                    return;
                                  }
                                  ...
                                  if (valueOrDefault(
                                    ...
                                    await showDialog(
                                      ...
                                      builder: (alertDialogContext) {
                                        return AlertDialog(
                                          title: Text('Admins Acccess'),
                                          content: Text(
                                              'You must be an admin to login here.'),
                                          actions: [
                                            TextButton(
