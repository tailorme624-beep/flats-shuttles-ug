...
import 'update_vehicle_model.dart';
export 'update_vehicle_model.dart';

/// Create a page design an admin edit Manage car
///  page with theme colors army green and light beige.
class UpdateVehicleWidget extends StatefulWidget {
  const UpdateVehicleWidget({super.key});

  static String routeName = 'UpdateVehicle';
  static String routePath = '/updateVehicle';

  @override
  State<UpdateVehicleWidget> createState() => _UpdateVehicleWidgetState();
}

class _UpdateVehicleWidgetState extends State<UpdateVehicleWidget> {
  late UpdateVehicleModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UpdateVehicleModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'UpdateVehicle'});
