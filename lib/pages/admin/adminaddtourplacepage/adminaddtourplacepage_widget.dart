...
import 'adminaddtourplacepage_model.dart';
export 'adminaddtourplacepage_model.dart';

/// design "ADD hotel" page for the admin to add available hotels to be viewed
/// by user when added by the admin.
///
/// with theme colors, light beige and army green
class AdminaddtourplacepageWidget extends StatefulWidget {
  const AdminaddtourplacepageWidget({super.key});

  static String routeName = 'adminaddtourplacepage';
  static String routePath = '/adminaddtourplacepage';

  @override
  State<AdminaddtourplacepageWidget> createState() =>
      _AdminaddtourplacepageWidgetState();
}

class _AdminaddtourplacepageWidgetState
    extends State<AdminaddtourplacepageWidget> {
  late AdminaddtourplacepageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdminaddtourplacepageModel());
                                ...
                                children: [
                                  ...
                                  TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      hintText:
                                          FFLocalizations.of(context).getText(
                                        'g58smtnn' /* Describe the place and attract... */,
                                      ),
                                      hintStyle: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
                                ...
                                children: [
                                  ...
                                  FlutterFlowChoiceChips(
                                    options: [
                                      ChipData(
                                          FFLocalizations.of(context).getText(
                                        'arhznrnk' /* Transportation */,
                                      )),
                                      ChipData(
                                          FFLocalizations.of(context).getText(
                                        'vpz4m9w1' /* Accommodation */,
                                      )),
                                      ChipData(
                                          FFLocalizations.of(context).getText(
                                        'aex63xsp' /* Meals */,
                                ...
                                children: [
                                  ...
                                  TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      hintText:
                                          FFLocalizations.of(context).getText(
                                        'igrzv1et' /* Any special requirements or no... */,
                                      ),
                                      hintStyle: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
