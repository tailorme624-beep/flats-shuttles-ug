...
import 'update_hotel_model.dart';
export 'update_hotel_model.dart';
...
class UpdateHotelWidget extends StatefulWidget {
  const UpdateHotelWidget({super.key});

  static String routeName = 'UpdateHotel';
  static String routePath = '/updateHotel';
...
class _UpdateHotelWidgetState extends State<UpdateHotelWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'UpdateHotel'});
