...
import 'adminprofilepage_model.dart';
export 'adminprofilepage_model.dart';
...
class _AdminprofilepageWidgetState extends State<AdminprofilepageWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'adminprofilepage'});
              ...
              actions: [
                Padding(
                  ...
                  child: FlutterFlowIconButton(
                    ...
                    onPressed: () async {
                      logFirebaseEvent('ADMINPROFILEsettings_ICN_ON_TAP');
