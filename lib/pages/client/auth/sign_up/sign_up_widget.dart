                      ...
                      children: [
                          ...
                          builder: (context, snapshot) {
                            ...
                            return TextFormField(
                              ...
                              onChanged: (_) => EasyDebounce.debounce(
                                ...
                                () async {
                                  logFirebaseEvent(
                                      'SIGN_UP_fullname_ON_TEXTFIELD_CHANGE');
                                  logFirebaseEvent('fullname_set_form_field');
                                  safeSetState(() {
                          ...
                          builder: (context, snapshot) {
                            ...
                            return TextFormField(
                              ...
                              onChanged: (_) => EasyDebounce.debounce(
                                ...
                                () async {
                                  logFirebaseEvent(
                                      'SIGN_UP_PAGE_email_ON_TEXTFIELD_CHANGE');
                        ...
                        StreamBuilder<List<UsersRecord>>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            List<UsersRecord> phoneUsersRecordList =
                                snapshot.data!;
                            // Return an empty Container when the item does not exist.
                            if (snapshot.data!.isEmpty) {
                              return Container();
                            ...
                            final phoneUsersRecord =
                                phoneUsersRecordList.isNotEmpty
                                    ? phoneUsersRecordList.first
                                    : null;
                            ...
                            return TextFormField(
                              ...
                              onFieldSubmitted: (_) async {
                                logFirebaseEvent(
                                    'SIGN_UP_PAGE_phone_ON_TEXTFIELD_SUBMIT');
                                logFirebaseEvent('phone_set_form_field');
                                safeSetState(() {
                        ...
                        StreamBuilder<List<UsersRecord>>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            return TextFormField(
                              ...
                              onFieldSubmitted: (_) async {
                                logFirebaseEvent(
                                    'SIGN_UP_confirm_password_ON_TEXTFIELD_SU');
                                logFirebaseEvent(
                                    'confirm_password_set_form_field');
                                safeSetState(() {
                          ...
                          children: [
                            StreamBuilder<List<UsersRecord>>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                List<UsersRecord> checkboxUsersRecordList =
                                    snapshot.data!;
                                // Return an empty Container when the item does not exist.
                                if (snapshot.data!.isEmpty) {
                                  return Container();
                                ...
                                final checkboxUsersRecord =
                                    checkboxUsersRecordList.isNotEmpty
                                        ? checkboxUsersRecordList.first
                                        : null;
