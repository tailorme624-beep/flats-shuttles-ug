...
///
/// Include fields for Event Type (Trip/Picnic - Radio), School/Organization
/// Name, Date & Time (Picker), Expected Number of Attendees
/// (Students/Chaperones), Location Preference (Dropdown/Search), and Special
                ...
                child: Column(
                  ...
                  children: [
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: FlutterFlowChoiceChips(
                                  options: [
                                    ChipData(
                                        FFLocalizations.of(context).getText(
                                      'ugr68v3y' /* School Trip */,
                                    )),
                                    ChipData(
                                        FFLocalizations.of(context).getText(
                                      'kajkzdxi' /* School Picnic */,
                                    ))
                                  ],
                              ...
                              Padding(
                                ...
                                child: Text(
                                  FFLocalizations.of(context).getText(
                                    'qurz2dil' /* School/Organization Name */,
                                  ),
                                  style: FlutterFlowTheme.of(context)
                                      .titleMedium
                                      .override(
                              ...
                              Padding(
                                ...
                                child: TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    hintText:
                                        FFLocalizations.of(context).getText(
                                      'g8y0ge8z' /* Enter school or organization n... */,
                                    ),
                              ...
                              Padding(
                                ...
                                child: FlutterFlowDropDown<String>(
                                  ...
                                  optionLabels: [
                                    ...
                                    FFLocalizations.of(context).getText(
                                      '5qgb9f1t' /* Science Museum */,
                                    ),
                                    FFLocalizations.of(context).getText(
                                      'x39xsnzi' /* Zoo */,
                                    ),
                                    FFLocalizations.of(context).getText(
                                      'iw0it2km' /* Historical Site */,
                                    ),
                                    FFLocalizations.of(context).getText(
                                      'l2pv2ta5' /* Adventure Park */,
                                    ),
                                    FFLocalizations.of(context).getText(
                                      'bc4xwj43' /* Beach/Lake */,
                                    ),
                                    FFLocalizations.of(context).getText(
                                      'u9vpst3v' /* Botanical Garden */,
                                    )
                                  ],
                                  ...
                                  hintText: FFLocalizations.of(context).getText(
                                    'd6p7n4k5' /* Select preferred location */,
                                  ),
                                  searchHintText:
                                      FFLocalizations.of(context).getText(
                                    '3pq2t1uh' /* Search locations... */,
                                  ),
                                  icon: Icon(
                                          ...
                                          child: Material(
                                            ...
                                            child: SwitchListTile(
                                              ...
                                              title: Text(
                                                FFLocalizations.of(context)
                                                    .getText(
                                                  'c12q8jek' /* Wheelchair Accessibility Requi... */,
                                                ),
                                                style: FlutterFlowTheme.of(
                                                        context)
                                                    .bodyMedium
                                          ...
                                          child: Material(
                                            ...
                                            child: SwitchListTile(
                                              ...
                                              title: Text(
                                                FFLocalizations.of(context)
                                                    .getText(
                                                  'b0wqa4bu' /* Special Dietary Requirements */,
                                                ),
                                                style: FlutterFlowTheme.of(
                                                        context)
                                                    .bodyMedium
                                        ...
                                        Material(
                                          ...
                                          child: SwitchListTile(
                                            ...
                                            title: Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                'nxa13dlr' /* First Aid Support Needed */,
                                              ),
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .bodyMedium
                              ...
                              Padding(
                                ...
                                child: TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    hintText:
                                        FFLocalizations.of(context).getText(
                                      'vsuubze2' /* Additional requirements or not... */,
                                    ),
                                    hintStyle: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
                          ...
                          child: Column(
                            ...
                            children: [
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Expanded(
                                      child: Text(
                                        FFLocalizations.of(context).getText(
                                          'kahxw0ia' /* Safety & Group Logistics */,
                                        ),
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                              ...
                              Padding(
                                ...
                                child: Text(
                                  FFLocalizations.of(context).getText(
                                    '2mdi0l38' /* • All trips include certified ... */,
                                  ),
                                  style: FlutterFlowTheme.of(context)
                                      .bodySmall
                                      .override(
                    ...
                    Align(
                      ...
                      child: Text(
                        FFLocalizations.of(context).getText(
                          'fgggwjqt' /* © 2025 FLATS UG. All rights re... */,
                        ),
