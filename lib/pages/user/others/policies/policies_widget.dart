...
class PoliciesWidget extends StatefulWidget {
  ...
  static String routeName = 'Policies';
  static String routePath = '/policies';
...
class _PoliciesWidgetState extends State<PoliciesWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'Policies'});
                            ...
                            Stack(
                              ...
                              children: [
                                InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'POLICIES_PAGE_Container_yd6va8ga_ON_TAP');
                                ...
                                InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'POLICIES_PAGE_Icon_gwodqz0e_ON_TAP');
...
• Acce... */
                            ...
                            Padding(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'POLICIES_PAGE_I_UNDERSTAND_BTN_ON_TAP');
