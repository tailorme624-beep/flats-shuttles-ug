              ...
              leading: Container(
                child: Padding(
                  ...
                  child: InkWell(
                    ...
                    onTap: () async {
                      logFirebaseEvent('HELP_CENTER_PAGE_Icon_i5p72o6r_ON_TAP');
                ...
                child: Column(
                  ...
                  children: [
                              ...
                              children: [
                                Expanded(
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'HELP_CENTER_PAGE_Row_dzgb05td_ON_TAP');
                                ...
                                InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'HELP_CENTER_PAGE_Icon_0r5qx7wp_ON_TAP');
                    ...
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            logFirebaseEvent(
                                'HELP_CENTER_Container_aokggqp7_ON_TAP');
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'HELP_CENTER_PAGE_Icon_dcyd1avh_ON_TAP');
                                      logFirebaseEvent('Icon_navigate_to');
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    logFirebaseEvent(
                                        'HELP_CENTER_CONTACT_US_NOW_BTN_ON_TAP');
                    ...
                    Align(
                      ...
                      child: Text(
                        FFLocalizations.of(context).getText(
                          'ysf2r7yg' /* © 2025 FLATS UG. All rights re... */,
                        ),
                        textAlign: TextAlign.center,
