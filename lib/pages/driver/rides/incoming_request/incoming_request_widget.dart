...
class IncomingRequestWidget extends StatefulWidget {
  ...
  static String routeName = 'IncomingRequest';
  static String routePath = '/incomingRequest';
...
class _IncomingRequestWidgetState extends State<IncomingRequestWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'IncomingRequest'});
                          ...
                          children: [
                            ...
                            Expanded(
                              child: FFButtonWidget(
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'INCOMING_REQUEST_AcceptButton_ON_TAP');
