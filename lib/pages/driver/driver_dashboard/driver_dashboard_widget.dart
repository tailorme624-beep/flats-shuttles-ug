...
/// Create a page for driver dashboard.
///
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child: Text(
                                          FFLocalizations.of(context).getText(
                                            'hj4gehmc' /* Ready for your next ride? */,
                                          ),
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      FFLocalizations.of(context).getText(
                                        '5x40peqv' /* Start accepting rides */,
                                      ),
                                                    ...
                                                    Padding(
                                                      ...
                                                      child: Text(
                                                        FFLocalizations.of(
                                                                context)
                                                            .getText(
                                                          '94ihs3mt' /* Today, 2:30 PM • 24.5 km */,
                                                        ),
                                                        style:
                                                            FlutterFlowTheme.of(
                                                                    context)
